...
class _opacityState extends State<opacity> {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [AnimatedOpacity(opacity: opacity, duration: Duration(microseconds: 600),
    child: Container(
      color: Colors.red,
      height: 100.0,
      width: 100.0,
      child: ElevatedButton(onPressed: (){
        animatedopacity();
      } ,child: Text("tap to fade"),style: ElevatedButton.styleFrom(primary: Colors.orange,
      ),
      ),
    ),
    )
